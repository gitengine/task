...
// Deviations from 01_v2Swap.js (the main code)
//// Removed gasLimit from swapExactTokensForTokens
//// Added await to line 60 await tx1.wait();
...
const main = async () => {
  ...
  const tx2 = await router
    ...
    ); // .swapExactTokensForTokens, https://docs.uniswap.org/contracts/v2/reference/smart-contracts/router-02
  await tx2.wait();
